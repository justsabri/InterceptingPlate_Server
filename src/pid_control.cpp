...
public:
                                                    ...
                                                    float brake_intensity = 1.0f)
    {
        ...
        // DF简化模型
        //10节以下完全不伸缩，10-15节线性变化，15-38节伸出50mm，38-40节线性变化，40-48节为25mm，48-50节线性变化，50节为12.5mm，55节以上完全收回
        if (x < 10)
        {
            y = 0;
        }
        ...
        {
            y = 25.0f - (x - 48) * (12.5f / 2.0f);
        }
        else
        {
            y = 12.5f - (x - 50) * (12.5f / 5.0f);
            if (y < 0)
                y = 0;
        }
